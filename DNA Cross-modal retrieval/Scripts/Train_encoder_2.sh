...
train_data_name="${model_name}_train_simi_data"
val_data_name="${model_name}_val_simi_data"
...
python ../train/train_encoder_2.py -m ${model_name} -t ${train_data_name} -v ${val_data_name} --thre ${thre}
#step_3 test_encoder
